 ...
 */
public abstract class ToyBaseServer_old extends Node implements Server {
    class fpEntry {
        Types.ForkProof fp;
        boolean done;
    }
    private final static org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(ToyBaseServer_old.class);
    WrbNode wrbServer;
     ...
     */
    public ToyBaseServer_old(String addr, int wrbPort, int id, int channel, int f,
     ...
     */
    public ToyBaseServer_old(String addr, int wrbPort, int id, int channel, int f, int tmo, int tmoInterval,
